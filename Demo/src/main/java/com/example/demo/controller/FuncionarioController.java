...
public class FuncionarioController {
    ...
    public Long qtdFuncionarios() {
        return funcionarioService.qtd();
    }

    @GetMapping("/{id}")
    public Optional<Funcionario> buscaPorID(@PathVariable Long id) {
        return funcionarioService.buscaPorID(id);
    }

    @GetMapping("/nome/{nome}")
    public Optional<Funcionario> buscaPorNome(@PathVariable String nome) { return funcionarioService.buscaPorNome(nome); }
}
